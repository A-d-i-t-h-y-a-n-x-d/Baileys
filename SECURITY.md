...
1. **Preferred:** [GitHub Security Advisories](https://github.com/Aadhixd777/Baileys/security/advisories/new) on this repository. This gives us a private workspace to coordinate the fix, draft a CVE, and notify downstream projects.
...
- **Pin a release.** Pulling `github:Aadhixd777/Baileys` always grabs `master`. Use a tagged release in production.
